...
const About = () => {
  return (
    <>
      <Header />
      <div className="h-screen w-screen bg-n1 pt-[13rem]">
        <div className="flex items-start gap-16 w-max mx-auto">
          ...
          <div className="text-2xl font-all font-semibold text-slate-400 max-w-[30rem] text-justify">
            <p>
              ...
              move which is <span className="text-n3">O</span> then the persone
              who connected three the moves downward horizontal or diagonal will
              be the winner. once the game is over Draw or Win you can reset and
              replay. Thank you.
            </p>
          </div>
        </div>
